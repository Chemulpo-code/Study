...
# 1. Сборка React фронтенда и установка зависимостей
...
# 2. Финальный образ приложения
FROM node:20-alpine
WORKDIR /app

LABEL version="1.9.8"
LABEL description="Chinese Study App v1.9.8"
...
COPY package*.json ./
# Копируем полные node_modules из этапа builder (гарантирует наличие express и всех зависимостей)
